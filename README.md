...
## Overview 
[^1]: This project was done as part of a graduate course, RBE502 Controls from RBE department of WPI, by myself and [dushyant6](https://github.com/dushyant6) under the guidance of [Professor Siavash Farzan](https://github.com/sfarzan). **This project is protected under copyright policy of the course and hence cannot be used without the permission of [Professor Siavash Farzan](https://github.com/sfarzan)**.
